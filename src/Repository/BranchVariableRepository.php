...
/**
 * BranchVariableRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class BranchVariableRepository extends \Doctrine\ORM\EntityRepository
{
    public function validate($form) {
        ...
        if($action !== 'd') {
            ...
            $branch_variableExist = $this->getEntityManager()->getRepository(BranchVariableEntity::class)
            ...
            if($action != 'u' && $branch_variableExist){
                $errors[] = 'Branch Variable already exist.';
            }
            ...
            if(empty($form['branch_variable_value'])){
                $errors[] = 'Value should not be blank.';
            }
        }
    ...
    public function ajax_list(array $get, array $userData){
        ...
        $columns = array(
            ...
            array('c.`branch_variable_value`', 'c.`branch_variable_value`'),
            array('c.`id`', "c.`id`")
        );
        $asColumns = array();

        $select = "SELECT";
        $from = "FROM `branch_variable` c";
        $joins = "";
        ...
        if($userData['type'] == 'Super Admin'|| in_array('Settings Branch Variable Update', $userData['accesses'])){

            $formUrl = $url . 'branch_variable/form';  
            $hasUpdate = true;
        }
