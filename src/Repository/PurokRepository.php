 ...
 */
class PurokRepository extends \Doctrine\ORM\EntityRepository
{
    public function validate($form) {
        ...
        if($action !== 'd') {
            ...
            $purokExist = $this->getEntityManager()->getRepository(PurokEntity::class)
            ...
            if($action != 'u' && $purokExist){
                $errors[] = 'Purok already exist.';
            }
    ...
    public function ajax_list(array $get, array $userData){
        ...
        if($userData['type'] == 'Super Admin'|| in_array('CMS Purok Update', $userData['accesses'])){

            $formUrl = $url . 'purok/form';  
            $hasUpdate = true;
        }
